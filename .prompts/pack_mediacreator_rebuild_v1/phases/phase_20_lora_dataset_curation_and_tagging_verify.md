# Phase 20 verify — LoRA dataset curation, prompt tagging, and training inputs

## Verify goal

Prove that Phase 20 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 20
...
6. Update `docs/verification/phase_20_verify.md`

## Exact verification steps

### Verify step 1
Create a dataset from a test character and confirm all expected image/caption files exist.

### Verify step 2
Confirm the dataset manifest records source assets and current tags.

### Verify step 3
Confirm prompt expansion logic can resolve a character tag to its visible expansion string.
...
Write these sections into `docs/verification/phase_20_verify.md`:
- Scope verified
- Commands run
