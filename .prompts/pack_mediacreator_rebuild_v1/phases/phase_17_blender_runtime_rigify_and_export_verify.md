# Phase 17 verify — Blender runtime, Rigify rig generation, and model attachment

## Verify goal

Prove that Phase 17 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 17
...
6. Update `docs/verification/phase_17_verify.md`

## Exact verification steps

### Verify step 1
Run a Blender background smoke job from the app.

### Verify step 2
Confirm a GLB is produced at the expected output path.

### Verify step 3
Confirm the GLB can be previewed in the web app.

### Verify step 4
Confirm job output metadata and history events are written.
...
Write these sections into `docs/verification/phase_17_verify.md`:
- Scope verified
- Commands run
