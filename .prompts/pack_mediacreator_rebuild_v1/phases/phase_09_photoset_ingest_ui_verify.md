# Phase 09 verify — Photoset ingest screen with drag/drop and thumbnail grid

## Verify goal

Prove that Phase 09 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 09
...
6. Update `docs/verification/phase_09_verify.md`

## Exact verification steps

### Verify step 1
Playwright drag-and-drop flow test with local files.

### Verify step 2
Verify thumbnails render correctly.

### Verify step 3
Verify image removal works before submit.

### Verify step 4
Verify the page contains no fake previously created characters or other demo content.
...
Write these sections into `docs/verification/phase_09_verify.md`:
- Scope verified
- Commands run
