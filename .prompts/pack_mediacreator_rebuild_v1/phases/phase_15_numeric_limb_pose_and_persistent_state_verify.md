# Phase 15 verify — Numeric limb posing and persistent pose state

## Verify goal

Prove that Phase 15 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 15
...
6. Update `docs/verification/phase_15_verify.md`

## Exact verification steps

### Verify step 1
API tests for pose update persistence.

### Verify step 2
Playwright tests for left/right arm and left/right leg updates.

### Verify step 3
Reload tests to confirm pose persistence.

### Verify step 4
History assertions for pose update events.
...
Write these sections into `docs/verification/phase_15_verify.md`:
- Scope verified
- Commands run
