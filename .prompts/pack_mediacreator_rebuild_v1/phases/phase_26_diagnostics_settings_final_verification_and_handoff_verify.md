# Phase 26 verify — Diagnostics, settings, final verification, polish, and handoff

## Verify goal

Prove that Phase 26 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 26
...
6. Update `docs/verification/phase_26_verify.md`

## Exact verification steps

### Verify step 1
Run the full verify suite and produce a machine-readable and human-readable report.

### Verify step 2
Verify the settings page contains only truthful information.

### Verify step 3
Verify the diagnostics page surfaces failures honestly.

### Verify step 4
Verify the README/handoff docs are sufficient for a new operator.
...
Write these sections into `docs/verification/phase_26_verify.md`:
- Scope verified
- Commands run
