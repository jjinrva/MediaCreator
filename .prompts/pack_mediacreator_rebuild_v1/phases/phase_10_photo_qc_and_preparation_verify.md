# Phase 10 verify — Photo QC and preparation pipeline

## Verify goal

Prove that Phase 10 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 10
...
6. Update `docs/verification/phase_10_verify.md`

## Exact verification steps

### Verify step 1
API integration test for multi-file upload.

### Verify step 2
Assert original, normalized, and thumbnail derivatives exist on disk and in metadata rows.

### Verify step 3
Assert QC metrics are stored and returned by the API.

### Verify step 4
Reload the ingest page and verify statuses are stable.
...
Write these sections into `docs/verification/phase_10_verify.md`:
- Scope verified
- Commands run
