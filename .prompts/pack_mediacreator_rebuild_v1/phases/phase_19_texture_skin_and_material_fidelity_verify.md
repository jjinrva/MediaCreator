# Phase 19 verify — Skin, color, texture, and material fidelity path

## Verify goal

Prove that Phase 19 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 19
...
6. Update `docs/verification/phase_19_verify.md`

## Exact verification steps

### Verify step 1
Confirm a test character export includes texture files or embedded texture data as expected.

### Verify step 2
Confirm the preview and output metadata identify whether the output is untextured, base-textured, or refined-textured.

### Verify step 3
Confirm history captures texture-generation or texture-update events.
...
Write these sections into `docs/verification/phase_19_verify.md`:
- Scope verified
- Commands run
