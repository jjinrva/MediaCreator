# Phase 08 verify — Guided capture assets and onboarding instructions

## Verify goal

Prove that Phase 08 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 08
...
6. Update `docs/verification/phase_08_verify.md`

## Exact verification steps

### Verify step 1
Confirm the guide route renders and that the documentation file exists.

### Verify step 2
Confirm the example rendered images are stored as assets and referenced correctly.

### Verify step 3
Verify the instructions page contains concrete actionable text, not placeholders.
...
Write these sections into `docs/verification/phase_08_verify.md`:
- Scope verified
- Commands run
