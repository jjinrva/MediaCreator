# Phase 22 verify — Wardrobe ingestion from photo, AI wardrobe generation, and closet catalog

## Verify goal

Prove that Phase 22 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 22
...
6. Update `docs/verification/phase_22_verify.md`

## Exact verification steps

### Verify step 1
Create one wardrobe item from a photo and confirm asset registry/history entries.

### Verify step 2
Create one wardrobe item from an AI prompt and confirm registry/history entries.

### Verify step 3
Confirm closet catalog lists real items.

### Verify step 4
Confirm color/material metadata survives reload.
...
Write these sections into `docs/verification/phase_22_verify.md`:
- Scope verified
- Commands run
