# Phase 16 verify — Face/expression parameter foundation

## Verify goal

Prove that Phase 16 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 16
...
6. Update `docs/verification/phase_16_verify.md`

## Exact verification steps

### Verify step 1
API contract test for facial parameter catalog.

### Verify step 2
If UI ships in this phase, Playwright tests for slider persistence and reload.

### Verify step 3
History assertions for facial parameter updates.
...
Write these sections into `docs/verification/phase_16_verify.md`:
- Scope verified
- Commands run
