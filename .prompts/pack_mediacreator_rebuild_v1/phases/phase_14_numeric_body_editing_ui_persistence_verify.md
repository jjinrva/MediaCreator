# Phase 14 verify — Numeric body editing UI and persistence loop

## Verify goal

Prove that Phase 14 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 14
...
6. Update `docs/verification/phase_14_verify.md`

## Exact verification steps

### Verify step 1
API tests for body parameter updates.

### Verify step 2
Playwright tests for slider movement, persisted save, and reload stability.

### Verify step 3
History assertions for body update events.

### Verify step 4
Unit tests for numeric slider and info tooltip rendering.
...
Write these sections into `docs/verification/phase_14_verify.md`:
- Scope verified
- Commands run
