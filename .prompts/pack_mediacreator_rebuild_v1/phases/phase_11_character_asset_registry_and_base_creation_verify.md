# Phase 11 verify — Character asset registry, history, and base-character creation

## Verify goal

Prove that Phase 11 is working the way the build document required. Do not accept screenshots or vague statements as proof. Use commands, API assertions, UI assertions, file assertions, and database checks where needed.

## Mandatory verification order

1. Read `AGENTS.md`
2. Read the paired build file for Phase 11
...
6. Update `docs/verification/phase_11_verify.md`

## Exact verification steps

### Verify step 1
API test for character creation from an accepted photoset.

### Verify step 2
Playwright create-and-redirect test.

### Verify step 3
DB assertions for asset lineage and history events.

### Verify step 4
Reload test for the detail page by public ID.
...
Write these sections into `docs/verification/phase_11_verify.md`:
- Scope verified
- Commands run
